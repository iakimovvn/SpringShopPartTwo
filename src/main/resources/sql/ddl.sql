...
create database onlineshop with owner vladimir;
...
alter table image owner to vladimir;
...
alter table product owner to vladimir;
...
alter function uuid_nil() owner to vladimir;
...
alter function uuid_ns_dns() owner to vladimir;
...
alter function uuid_ns_url() owner to vladimir;
...
alter function uuid_ns_oid() owner to vladimir;
...
alter function uuid_ns_x500() owner to vladimir;
...
alter function uuid_generate_v1() owner to vladimir;
...
alter function uuid_generate_v1mc() owner to vladimir;
...
alter function uuid_generate_v3(uuid, text) owner to vladimir;
...
alter function uuid_generate_v4() owner to vladimir;
...
alter function uuid_generate_v5(uuid, text) owner to vladimir;